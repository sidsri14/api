      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-amber-600 dark:text-amber-400 mt-1">
            Use this to verify the <code className="font-mono bg-amber-100 dark:bg-amber-900/40 px-1 py-0.5 rounded">x-payrecover-signature</code> header on incoming webhook deliveries.
          </p>
        </div>
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <input
            type="url"
            placeholder="https://your-server.com/webhooks/payrecover"
            value={url}
  ...
  return (
    ...
    >
      ...
      <div className="border border-stone-100 dark:border-stone-800 rounded-2xl p-5 bg-stone-50/50 dark:bg-stone-900/30 text-xs text-stone-500 dark:text-stone-400 space-y-2">
        ...
        <p>Each delivery includes an <code className="font-mono bg-stone-100 dark:bg-stone-800 px-1 py-0.5 rounded">x-payrecover-signature: sha256=&lt;hex&gt;</code> header.</p>
      ...
      <ConfirmModal
        ...
        message="PayRecover will stop sending events to this URL. You can re-add it at any time."
        confirmText="Remove"
        isDestructive
      />
    </motion.div>
